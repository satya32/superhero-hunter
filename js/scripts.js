// Public key
// aea5f357d834ed1580fbed9980c78653

// Private Key
// c9616f58b61433409164bca028bfc4158a862a88
...
async function searchHeros(textSearched) {
     ...
     console.log('textSearched :' , textSearched);
     ...
     await fetch(`https://gateway.marvel.com/v1/public/characters?nameStartsWith=${textSearched}&apikey=9ab871748d83ae2eb5527ffd69e034de&hash=915c6de8937cedf1181f55815a6be024?ts=1`)
...
console.log(' searchedHero : ' , searchedHero);
     ...
     console.log('favouritesCharacterIDs :', favouritesCharacterIDs);
